...
//        TODO set user etEmail by default with Shared Preferences
        ...
        if(reportEmail !=null && !reportEmail.equals("")) {
            ...
            if (appointments.size() > 0) {
                ...
                //            TODO Report handling if empty.
                Toast.makeText(GenerateReportActivity.this, "No Rides match the criteria", Toast.LENGTH_LONG).show();
            }
        }else{
            Toast.makeText(GenerateReportActivity.this, "Report filed", Toast.LENGTH_LONG).show();
        }
    ...
    class GenerateReportTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(Boolean result) {
            pd.dismiss();
            if (result)
                Toast.makeText(GenerateReportActivity.this, "Report Generated", Toast.LENGTH_LONG).show();
            else
                Toast.makeText(GenerateReportActivity.this, "Report Failure", Toast.LENGTH_LONG).show();
